...
open class CirclePagerIndicatorDecoration(
	context: Context,
	@ColorRes colorActive: Int,
	@ColorRes colorInActive: Int
) :
	RecyclerView.ItemDecoration() {
	private val colorActive = ContextCompat.getColor(context, colorActive)
	private val colorInactive = ContextCompat.getColor(context, colorInActive)
	 ...
	 * Indicator width.
	 */
	private val mIndicatorItemLength = DP * 5
